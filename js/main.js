...
updateRestaurants = () => {
  ...
  /* Offline handling of remembering a user's selectons (go away and then come back to the page) */
  ...
  /* If there is any data in localStorage -> user navigated back to main page from restaurant.html; 
		else -> just use his current selection */
  if (!cuisine) {
